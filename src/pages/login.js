  ...
  return (
    <div className="w-full flex">
      <div className="w-full hidden md:flex flex-col rounded-r-[20px] bg-[#F8EAFF]">
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="flex flex-col justify-center items-center mt-3 Lora font-semibold">
            <p className="text-[#61227D] text-[18px] lg:text-[20px]">Team Achieve</p>
      ...
      <div className="w-full bg-[#FCFCFC] h-[100vh]">
        <div className="w-full flex justify-center mt-20 NoraSans">
          <div className="w-[80%] sm:w-[65%] md:w-[90%] lg:w-[85%] xl:w-[80%]  pb-10 flex flex-col gap-[32px]">
            <div className="w-full justify-center text-center">
              <p className="text-[32px] text-[#61227D] Lora font-semibold">Welcome Back</p>
              <p>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-[8px]">
                ...
                <div className="flex items-center border border-[#DDDDDD] pr-1 bg-[#F6F6F6] rounded-[5px]">
                  ...
                  >
                    <img src={eye} className="w-[24px] h-[24px] cursor-pointer" alt="/" />
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3 text-center text-[14px]">
                <button className="shadow bg-[#61227D] text-white font-semibold h-[48px] w-full rounded-[8px] flex justify-center items-center">Sign in</button>

                <p className="text-[#5E5E5E] font-thin">Don’t have an account? <span className="text-[#61227D] font-semibold">Sign up</span></p>
            </div>
          </div>
        </div>
      </div>
